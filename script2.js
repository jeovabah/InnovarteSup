...
function displayCart(){
    ...
    if( cartItems && productContainer ) {
        ...
        Object.values(cartItems).map(item => {
            productContainer.innerHTML += ` <div class="product"><ion-icon name="close-circle"></ion-icon> <img src="./midia/${item.tag}.jpeg"> <span style="border-right:4px solid black">${item.name}</span> 
            </div>
            <div class="price"> 
